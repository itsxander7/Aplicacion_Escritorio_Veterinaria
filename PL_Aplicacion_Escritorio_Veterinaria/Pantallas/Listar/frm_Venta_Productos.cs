...
{
    public partial class frm_Venta_Productos : Form
    {
        ...
        public frm_Venta_Productos()
        {
            InitializeComponent();
        }

        private void frm_Venta_Productos_Load(object sender, EventArgs e)
        {
            ...
            using (Timer t = new Timer())
            {
                ...
                time.Start();
                MessageBox.Show("Bienvenido(a) al módulo de Ventas de Productos, en el cual podrás registrar tus facturas de venta de mercadería.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        ...
        private void tls_lbl_eliminar_Click(object sender, EventArgs e)
        {
        ...
        private void frm_Venta_Productos_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void dgv_FacturacionProductos_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
        ...
        private void ValidarFechas(MaskedTextBox Obj_CajaTexto, char flag)
        {
            ...
            else
            {
                ...
                if (flag == 'V')
                {
                    dgv_FacturacionProductos.Enabled = true;
